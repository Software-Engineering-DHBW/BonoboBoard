...
class LectureImporter(Importer):
    ...
    def limit_weeks_in_list(self, offset: int) -> DataFrame: ...
...
def _write_lecture_links_to_database(df: DataFrame, user_uid: str) -> None: ...


def read_lecture_links_from_database(user_uid: str) -> DataFrame: ...


def add_lecture_links_to_database(user_uid: str, event: str, link: str) -> DataFrame: ...
